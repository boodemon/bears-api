<?php
	...
	$xls->getActiveSheet()->getDefaultStyle()->getFont()->setName("Cordia New")->setSize(16);
	$xls->getActiveSheet()->getPageSetup()->setOrientation(PHPExcel_Worksheet_PageSetup::ORIENTATION_LANDSCAPE);
	$xls->getActiveSheet()->getPageSetup()->setPaperSize(PHPExcel_Worksheet_PageSetup::PAPERSIZE_LEGAL);
